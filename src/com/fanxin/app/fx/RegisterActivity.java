...
//                options.inJustDecodeBounds = true;
    ...
    public void register(final String hxid, final String password) {
        // String st1 = getApplicationContext().getResources().getString(
        // R.string.User_name_cannot_be_empty);
        // String st2 = getResources()
        // .getString(R.string.Password_cannot_be_empty);
        // String st3 = getApplicationContext().getResources().getString(
        // R.string.Confirm_password_cannot_be_empty);
        // String st4 = getApplicationContext().getResources().getString(R.string.Two_input_password);
        // String st5 = getApplicationContext().getResources().getString(R.string.Is_the_registered);
        final String st6 = getApplicationContext().getApplicationContext().getResources().getString(
                R.string.Registered_successfully);

        if (!TextUtils.isEmpty(hxid) && !TextUtils.isEmpty(password)) {

            final String st7 = getApplicationContext().getApplicationContext().getResources().getString(
                    R.string.network_anomalies);
            final String st8 = getApplicationContext().getResources().getString(
                    R.string.User_already_exists);
            final String st9 = getApplicationContext().getResources().getString(
                    R.string.registration_failed_without_permission);
            final String st10 = getApplicationContext().getResources().getString(
